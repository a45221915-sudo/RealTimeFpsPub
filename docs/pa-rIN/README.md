...
* `adb shell appops set com.tribalfs.realtimefps PROJECT_MEDIA allow` ਚਲਾਓ
* ਜੇਕਰ ਉੱਚ ਇਜਾਜ਼ਤ (Elevated Permission) ਵਾਲੀ ਐਂਡਰਾਇਡ ਟਰਮੀਨਲ ਐਪ ਦੀ ਵਰਤੋਂ ਕਰ ਰਹੇ ਹੋ, ਤਾਂ
  `appops set com.tribalfs.realtimefps PROJECT_MEDIA allow` ਚਲਾਓ
...
* ਜੇਕਰ ਤੁਹਾਡਾ ਫ਼ੋਨ ਪਹਿਲੀ ਵਾਰ USB ਡੀਬਗਿੰਗ ਮੋਡ 'ਤੇ ਕਨੈਕਟ ਹੋ ਰਿਹਾ ਹੈ ਤਾਂ ਇਹ _वी USB डीघगिंग री भर्गਗਮਾ
  ਰੇਟੀ ਹੈ?_ ਦਾ
  ਸੁਨੇਹਾ ਦਿਖਾਏਗਾ। _6ਵੇ_ 'ਤੇ ਟੈਪ ਕਰੋ।
* ਤੁਸੀਂ _ਗਮੇਸ਼ਾਂ ਇਸ ਕੰਪਿਊਟਰ ਤੋਂ ਆਗਿਆ ਦਿਓ_ ਨੂੰ ਚੈੱਕ ਕਰ ਸਕਦੇ ਹੋ (USB ਡੀਬਗਿੰਗ ਨੂੰ ਸਮਰੱਥ ਰੱਖਣ ਬਾਰੇ
  ਇਸ
...
### 7. Real-time FPS Monitor ਨੂੰ PROJECT_MEDIA ਇਜਾਜ਼ਤ ਦੇਣਾ
...
>
```adb -s [ਪੜਾਅ 6 ਵਿੱਚ ਦਿਖਾਈ ਗਈ ਡਿਵਾਈਸ ਆਈਡੀ] shell appops set com.tribalfs.realtimefps PROJECT_MEDIA allow```
...
ਅਤੇ ਇਸਦੇ ਦੁਆਰਾ ਦਿੱਤੀ ਗਈ ਗਾਈਡ ਦੀ ਪਾਲਣਾ ਕਰਕੇ ਇਸਨੂੰ ਸਰਗਰਮ ਕਰ ਸਕਦੇ ਹੋ। ਫਿਰ Shizuku ਦੀ ਵਰਤੋਂ ਕਰਕੇ ਇਜਾਜ਼ਤ
ਦੇਣ ਲਈ _Real-time FPS_ ਐਪ 'ਤੇ ਵਾਪਸ ਜਾਓ।

*ਜੇਕਰ ਪਲੇ ਸਟੋਰ ਵਰਜ਼ਨ ਤੁਹਾਡੀ ਡਿਵਾਈਸ 'ਤੇ ਕੰਮ ਨਹੀਂ ਕਰਦਾ ਹੈ, ਤਾਂ ਤੁਸੀਂ ਇਸ ਦੀ ਬਜਾਏ
ਇਸ [Shizuku fork](https://github.com/thedjchi/Shizuku/releases) ਦੀ ਵਰਤੋਂ ਕਰ ਸਕਦੇ ਹੋ।
...
### ਤੁਹਾਨੂੰ ਇਸ ਪ੍ਰਕਿਰਿਆ ਨੂੰ ਦੁਹਰਾਉਣ ਦੀ ਲੋੜ ਨਹੀਂ ਹੈ ਜਦੋਂ ਤੱਕ ਤੁਸੀਂ ਐਪ ਨੂੰ ਪੂਰੀ ਤਰ੍ਹਾਂ ਅਣਇੰਸਟਾਲ ਕਰਕੇ ਦੁੁਬਾਰਾ ਇੰਸਟਾਲ ਨਹੀਂ ਕਰਦੇ।
