...
* ਜੇਕਰ ਉੱਚ ਇਜਾਜ਼ਤ (Elevated Permission) ਵਾਲੀ ਐਂਡਰਾਇਡ ਟਰਮੀਨਲ ਐਪ ਦੀ ਵਰਤੋਂ ਕਰ ਰਹੇ ਹੋ, ਤਾਂ
  `pm grant com.tribalfs.realtimefps android.permission.PROJECT_MEDIA` ਚਲਾਓ
...
ਇਸ ਤੋਂ ਬਾਅด, _Real-time FPS Monitor_ ਐਪ 'ਤੇ ਵਾਪਸ ਜਾਓ ਅਤੇ ਰੈਜ਼ੋਲਿਊਸ਼ਨ ਲਾਗੂ ਕਰਕੇ ਇਸਨੂੰ ਇਜਾਜ਼ਤ ਦਿਓ।
